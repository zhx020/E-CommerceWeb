	...
	<div class="container">
		<div class="row row-centered">
			<div class="well col-md-6 col-centered">
				<form action="/shopping-car/goods/add" method="post" role="form">
        ...
        (
            {
                ...
                {
                    $("#img").attr("src", "/shopping-car/" + data.data);
                    $("#image").attr("value",data.data);
                },
                error: function (data, status, e)//服务器响应失败处理函数
                {
                	var response = JSON.parse(data.responseText);
                	$("#img").attr("src", "/shopping-car/" + response.data);
                	$("#image").attr("value",response.data);
                }
            }
        )
        return false;
